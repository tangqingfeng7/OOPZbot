...
def _load_admin_template() -> string.Template:
    ...
    if _ADMIN_SHELL_TEMPLATE is None:
        tpl_path = os.path.join(os.path.dirname(__file__), "assets", "admin", "admin-shell-template.html")
...
def _render_admin_page(page_key: str) -> HTMLResponse:
    ...
    pages_dir = os.path.join(os.path.dirname(__file__), "assets", "admin", "pages")
